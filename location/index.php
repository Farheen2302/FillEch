					...
					<div class="col-sm-7">
						 <ul class="nav nav-tabs">
						  <li class="active"><a data-toggle="tab" href="#details">Details</a></li>
										...
										<br>
					  <?php $result=$conn->query("select * from location where location.p_id in(select p_id from project_manager where pm_name='$uname')");
										...
										echo "There are no locations!";
										  ...
										  <div id="remove" class="tab-pane fade">
										      <h3>Select the Location you want to remove</h3>
										    	...
										    	<?php $result1=$conn->query("select * from location where location.p_id in(select p_id from project_manager where pm_name='$uname')");
