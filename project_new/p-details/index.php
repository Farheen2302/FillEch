				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="wow bounceInLeft" data-wow-delay="0.1s"> 
						<h1>Project Details</h1> 
							...
							<h2><font color="blue">PROJECT</font></h2>
							<h3><font color="green">Project Name : </font><font color="maroon"><?php echo $row['p_name'];?></font></h3>
							...
							$row=$result->fetch_assoc();?>
							<h2><font color="blue">ACHIEVEMENTS</font></h2>
							<h3><font color="green">Achievement Title:</font><font color="maroon"><?php echo $row['ac_title'];?></font></h3>
							<h3><font color="green">Achievement Details:</font><font color="maroon"><?php echo $row['ac_details'];?></font></h3>
							<br><br>
							<?php $result=$conn->query("select * from fund where p_id='$p_id'");
							//if($result->num_rows>0)
							$row=$result->fetch_assoc();?>
							<h2><font color="blue">FUND</font></h2>
							<h3><font color="green">Fund Amount:</font><font color="maroon"><?php echo $row['fund_amount'];?></font></h3>
							<h3><font color="green">Fund By :</font><font color="maroon"><?php echo $row['fund_by'];?></font></h3>
							<br><br>

							<?php $result=$conn->query("select * from volunteer where p_id='$p_id'");
							//if($result->num_rows>0)
							$row=$result->fetch_assoc();?>
							<h2><font color="blue">VOLUNTEER</font></h2>
							<h3><font color="green">Volunteer Name:</font><font color="maroon"><?php echo $row['v_name'];?></font></h3>
							<h3><font color="green">Volunteer Contact :</font><font color="maroon"><?php echo $row['v_contact'];?></font></h3>
							<br><br>
							<?php 
							$result=$conn->query("select * from project_manager where p_id='$p_id'");
							//if($result->num_rows>0)
							$row=$result->fetch_assoc();?>
							<h2><font color="blue">PROJECT MANAGER</font></h2>
							<h3><font color="green"> Project Manager Name:</font><font color="maroon"><?php echo $row['pm_name'];?></font></h3>
							<h3><font color="green">Manager Contact :</font><font color="maroon"><?php echo $row['pm_contact'];?></font></h3>
							<br><br>
