...
<body>
    ...
    <section class="aboutus" id="projects">
		<div class="container">
 							 ...
 							 <div class="panel panel-default">
    							...
    							<div  class="panel-collapse collapse" id="collapse1">
									...
									{ 
										...
										{ 
										?>
        								<h5><a href="p_details.php?var=<?php echo $row["p_id"] ?>"><?php echo $row["p_name"];?></a>
 										</h5>
 										<?php
 										}   		
  							...
  							<div class="panel panel-default">
    							...
    							<div  class="panel-collapse collapse" id="collapse2">
									...
									{ 
										...
										{ 
										?>
        								<a href="p_details.php?var=<?php echo $row["p_id"] ?>"><?php echo $row["p_name"];?></a>
 										<br>
 										<?php
 										}   		
			...
			<div><button onclick="location.href='index.php#manage_projects'" type="button" id="add-button">Manage Project</button>
			</div>
		</div>
